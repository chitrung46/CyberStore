...
<head>
    ...
    <link rel="stylesheet" href=".\asset\css\ProductInfo-style.css">
    <link rel="stylesheet" href=".\asset\css\main.css">
    <link rel="stylesheet" href=".\asset\css\index.css">
    <link rel="stylesheet" href=".\asset\css\slider.css">

    <link rel="stylesheet" href=".\asset\css\quickview.css">
    <link rel="stylesheet" href=".\asset\scss\_modal.scss">
...
<body>
   ...
   TÍNH NĂNG RESPONSIVE, KÉO RESIZE TRÌNH DUYỆT WEB ĐỂ XEM KẾT QUẢ
    ...
    xs = extra small = màn hình điện thoại nhỏ
    sm = small = màn hình máy tính bảng hoặc điện thoại lớn
    md = medium = màn hình desktop nhỏ hoặc tablet lớn
    lg = large = màn hình máy tính độ phân giải cao
    xl = extra large = màn hình máy tính độ phân giải cao nhất
 ...
 -->
    ...
    <div class="wrapper">
        ...
        <div class="top-banner position-raletive" style="background-color: #61317F;">
            Key of Word - The World of Keyboard
        ...
        <section class="section awe-section-1">
            <div class="section_slider clearfix" style="">
                            ...
                            <div class="row mt-3" data-section="tab-section">
                                ...
                                <div class="col-12 col-xl-15 product-col">
                                    <div class="item_product_main">
                                        ...
                                        <form action="/cart/add" method="post" class="variants product-action" data-id="product-actions-35113526"
                                            enctype="multipart/form-data">
                                            <div class="product-thumbnail pos-relative">
                                                <a class="image_thumb pos-relative embed-responsive embed-responsive-1by1" href="/bo-keycap-cute-cat"
                                                    title="Bộ keycap Cute Cat (MAO / PBT Dyesub)">
                                                    <img loading="lazy" class="img-fetured" width="480" height="480" style="--image-scale: 1;"
                                ...
                                <div class="col-12 col-xl-15 product-col">
                                    <div class="item_product_main">
                                        ...
                                        <form action="/cart/add" method="post" class="variants product-action" data-id="product-actions-34508041"
                                            enctype="multipart/form-data">
                                            <div class="product-thumbnail pos-relative">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <span class="product-name "><a class="link" href="/order-mousepad-spy-x-family-anya-edition"
                                                        title="[Order] Mousepad - Spy x Family (Anya Edition)">[Order] Mousepad - Spy x Family (Anya
                                                        Edition)</a></span>
                                                <div class="product-item-cta position-relative">
                                                    <div class="price-box">
                                                ...
                                                <div class="product-promotion hidden">
                                                    ...
                                                    <ul>
                                                        <li><b>Đây là sản phẩm order, thời gian trả hàng dự kiến: Cuối quý 2/2024</b></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </form>
                        ...
                        <div class="col-lg-3">
                            <div class="footer-block footer-click">
                                ...
                                <div class="single-contact">
                                    ...
                                    <div class="content">
                                        Số điện thoại: <a class="link" title="0888115511"
                                            href="tel:0888115511">0888115511</a>
                                    </div>
                                </div>
                                <div class="single-contact">
                                    ...
                                    <div class="footer-block footer-click">
                                        ...
                                        <div class="form_register ">
                                            ...
                                            <iframe frameborder="0" id="iframewin" width="100%" height="100%"
                                                src="https://zcvrp-zgvfh.maillist-manage.com/ua/Optin?od=11287ecc4a1546&amp;zx=12f9973b8&amp;tD=1f676f1c2e804fc9&amp;sD=1f676f1c2e866e65"></iframe>
                                        </div>
                    ...
                    <div class="product-center-column product-info product-item col-xs-12 col-sm-6 col-md-8 col-lg-7 col-xl-6 details-pro style_product style_border"
                        ...
                        <div class="quickview-info clearfix">
                            <span class="prices price-box">
                                ...
                                <span class="label_product">-13%</span>
                            </span>
                        </div>
    ...
    <link rel="preload" as="script" href=".\asset\js\api.jquery.js">


    <!-- SCRIPTS -->
    <script src=".\asset\js\stast.js"></script>
    <script src=".\asset\js\scrip.js"></script>
    <script src=".\asset\js\product.js"></script>
    <script src=".\asset\js\index.js"></script>
    <script src=".\asset\js\api-jquery-custom.js"></script>
    <script src=".\asset\js\ega-gateway-min.js"></script>
