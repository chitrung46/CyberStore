...
addToCartButtons.forEach(function(button) {
    button.addEventListener('click', function(event) {
        ...
        cart.push({ name: productName, price: productPrice, image: productImage, variantId: variantId });
...
function updateCartUI() {
    ...
    if (cart.length === 0) {
                ...
                <li class="shopping__cart-item">
                    ...
                    <div class="shopping__cart-item-info">
                        ...
                        <div class="shopping__cart-item-body">
                            ...
                            <button class="shopping__cart-item-remove" data-index="${index}">Xóa</button>
                        </div>
                    </div>
                </li>`;
        });
        ...
        // Gắn sự kiện click cho nút "Xóa" cho các phần tử mới được thêm vào
