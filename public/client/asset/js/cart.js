...
function updateCartUI() {
    ...
    if (cart.length === 0) {
        ...
        // imgElement.src = "{{ asset('client/asset/img/empty-cart.svg') }}";
        // imgElement.className = "shopping__cart-list--no-cart-img";
        shoppingCartList.innerHTML = `
            <p class="shopping__cart-list--no-cart-msg">Không có sản phẩm nào</p>`;
    } else {
